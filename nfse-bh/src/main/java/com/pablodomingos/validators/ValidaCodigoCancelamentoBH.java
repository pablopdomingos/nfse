...
public class ValidaCodigoCancelamentoBH implements ConstraintValidator<ValidaCodigoCancelamentoBH.Validate, CodigoCancelamento> {

  @Target({ElementType.FIELD})
  @Retention(RetentionPolicy.RUNTIME)
  @Constraint(validatedBy = ValidaCodigoCancelamentoBH.class)
